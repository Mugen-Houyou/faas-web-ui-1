...
async def run_code(
    ...
    # ``process.communicate`` writes the provided input and immediately closes
    # the stdin pipe. Programs attempting to read beyond the supplied data will
    # receive EOF rather than blocking forever.
